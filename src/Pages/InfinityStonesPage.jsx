    ...
    return (
        <div className='infinity-stones-section'>
            <div className='infiity-stone-component'>
                <h1 className='stone-component-header'>Soul Stone</h1>
                <p className='stone-component-paragraph'>
            ...
            <div className='infiity-stone-component'>
                <h1 className='stone-component-header'>Mind Stone</h1>
                <p className='stone-component-paragraph'>
            ...
            <div className='infiity-stone-component'>
                <h1 className='stone-component-header'>Reality Stone</h1>
                <p className='stone-component-paragraph'>
            ...
            <div className='infiity-stone-component'>
                <h1 className='stone-component-header'>Power Stone</h1>
                <p className='stone-component-paragraph'>
            ...
            <div className='infiity-stone-component'>
                <h1 className='stone-component-header'>Time Stone</h1>
                <p className='stone-component-paragraph'>
